...
public final class MinecraftProtocolVersion {
    ...
    private static NavigableMap<MinecraftVersion, Integer> createLookup() {
        ...
        map.put(new MinecraftVersion(1, 21, 1), ProtocolConstants.MINECRAFT_1_21_1);
        ...
        map.put(new MinecraftVersion(26, 1, 1), ProtocolConstants.MINECRAFT_26_1_1);
        map.put(new MinecraftVersion(26, 1, 2), ProtocolConstants.MINECRAFT_26_1_2);
